...
<div class="mdc-dialog"
   ...
   -->
            ...
            <footer class="mdc-dialog__actions">
                <button type="button" class="mdc-button mdc-dialog__button mdc-light" data-mdc-dialog-action="no">
                    <span class="mdc-button__label">{{trans('laravel-lang::language_picker.close')}}</span>
                </button>
                <button type="button" class="mdc-button mdc-dialog__button mdc-dark" data-mdc-dialog-action="yes">
